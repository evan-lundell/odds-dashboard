...
const betSchema = new Schema<BetDocument>(
  {
    ...
    type: { type: String, enum: ['straight', 'parlay'], required: true, default: 'straight' },
    legs: { type: [betLegSchema], required: true },
...
betSchema.index({ 'legs.gameId': 1, status: 1 });
